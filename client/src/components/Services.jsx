  ...
  const Services = () => {
    ...
    return (
      <Box sx={{ marginTop: 15, marginBottom: 5, overflow: "hidden", paddingInline: 0 }}>
        {/* Video Background */}
        <Box className="relative w-full" sx={{ height: "50vh", width: "100vw", overflow: "hidden" }}>
          <video
            className="absolute top-0 left-0"
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover", // Make sure the video covers the entire screen
              margin: 0,
            }}
            autoPlay
            muted
